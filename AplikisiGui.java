...
public class AplikisiGui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabelidentitas.setBackground(new java.awt.Color(255, 204, 255));
        tabelidentitas.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 51, 102)));
        ...
        in_nim.setBackground(new java.awt.Color(255, 204, 255));
        ...
        in_nama.setBackground(new java.awt.Color(255, 204, 255));
        ...
        in_alamat.setBackground(new java.awt.Color(255, 204, 255));
        in_alamat.setColumns(20);
        in_alamat.setRows(5);
        jScrollPane2.setViewportView(in_alamat);

        cari.setBackground(new java.awt.Color(255, 102, 153));
        cari.setText("Cari");
        ...
        pilih.setBackground(new java.awt.Color(255, 51, 153));
        ...
        jLabel1.setText("ILMU KOMPUTER UNU BLITAR");

        jLabel2.setText("Status Koreksi");

        statuskoneksi.setBackground(new java.awt.Color(255, 51, 102));

        jLabel7.setFont(new java.awt.Font("Humnst777 Lt BT", 1, 14)); // NOI18N
    ...
    public void selectByNama(String nama) {
        ...
        try {
            String sql = "select * from tabel where nama like '%" + nama + "%'";
            pst = konek.con.prepareStatement(sql);
            rs = pst.executeQuery(sql);
            tabelidentitas.setModel(DbUtils.resultSetToTableModel(rs));
        } catch (Exception e) {
    ...
    public void selectByAlamat(String alamat) {
        ...
        try {
            String sql = "select * from tabel where alamat like '%" + alamat + "%'";
            pst = konek.con.prepareStatement(sql);
            rs = pst.executeQuery(sql);
            tabelidentitas.setModel(DbUtils.resultSetToTableModel(rs));
        } catch (Exception e) {
    ...
    public void selectByjk(String jenis) {
        ...
        try {
            String sql = "select * from tabel where jeniskelamin like '%" + jenis + "%'";
            pst = konek.con.prepareStatement(sql);
            rs = pst.executeQuery(sql);
            tabelidentitas.setModel(DbUtils.resultSetToTableModel(rs));
        } catch (Exception e) {
    ...
    private void tabelidentitasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelidentitasMouseClicked
        ...
        try {
            ...
            String sql = "select * from tabel where nim like '%" + id + "%'";
            pst = (Statement) konek.con.prepareStatement(sql);
